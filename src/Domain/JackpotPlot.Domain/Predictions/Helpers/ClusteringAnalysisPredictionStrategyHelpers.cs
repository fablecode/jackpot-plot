...
{
    public static int[,] GenerateCoOccurrenceMatrix(IReadOnlyList<HistoricalDraw> historicalDraws, int numberRange)
    {
    ...
    public static double CalculateClusteringAnalysisConfidence(List<List<int>> clusters, ImmutableArray<int> predictedNumbers)
    {
