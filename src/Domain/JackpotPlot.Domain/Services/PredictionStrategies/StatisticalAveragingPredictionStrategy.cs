...
[PredictionStrategyDescription(PredictionStrategyType.StatisticalAveraging, "Computes averages (mean/median) of historical draws to predict numbers that tend to cluster around these average values.")]
