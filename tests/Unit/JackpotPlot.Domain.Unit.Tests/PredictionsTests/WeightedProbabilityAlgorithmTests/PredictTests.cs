...
namespace JackpotPlot.Domain.Unit.Tests.PredictionsTests.WeightedProbabilityAlgorithmTests;
...
public class PredictTests
{
    ...
    [Test]
    public void Given_No_History_When_Predict_Is_Invoked_Should_Return_Empty_NumbersPredictedNumbers()
    {
        // Arrange
        var config = CreateConfig();
        var history = Array.Empty<HistoricalDraw>();
        var rng = new Random(1);
        var sut = new WeightedProbabilityAlgorithm();
    ...
    public void Given_History_When_Predict_Is_Invoked_Should_Set_AlgorithmKey()
    {
        ...
        // Assert
        result.AlgorithmKey.Should().Be(PredictionAlgorithmKeys.WeightedProbability);
    }
